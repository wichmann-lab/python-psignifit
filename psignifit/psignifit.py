...
from .utils import (pool_data, integral_weights, PsignifitException, normalize, get_grid, check_data)
...
def psignifit(data, conf=None, **kwargs):
    ...
    data = check_data(data, verbose=conf.verbose, logspace=sigmoid.logspace,
